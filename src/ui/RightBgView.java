...
public class RightBgView {
    public static void rightBgView(Graphics big, BG map, Hero hero) {
        ...
        //小地图坐标
        big.drawString("坐标"+(hero.hero.getMove().getX()-map.Map.getImg()[0].getX())+":"+hero.hero.getMove().getY(),890,70);
        //小人的位置
        big.drawImage(map.Map.getSmallMapMask()[map.Map.getSmallMapMask().length - 1].getPicturePath(),
                map.Map.getSmallMapMask()[map.Map.getSmallMapMask().length - 1].getX() + hero.hero.getMove().getX() / 23 - map.Map.getImg()[0].getX()/23,
        ...
        big.drawImage(map.Map.getSmallMapMask()[map.Map.getSmallMapMask().length - 2].getPicturePath(),
                map.Map.getSmallMapMask()[map.Map.getSmallMapMask().length - 2].getX() + hero.hero.getMove().getX() / 23 - map.Map.getImg()[0].getX()/23,
